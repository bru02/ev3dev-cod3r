!function (e, r) {
    "use strict";
    r.module("FileManagerApp", ["pascalprecht.translate", "ngFileUpload", "ui.ace"]),
            ...
            r.config = t,
                ...
                r.openEditItem = function () {
                    ...
                    r.apiMiddleware.getContent(e).then(function (r) {
                        ace.edit('code-editor').session.setMode(ace.require('ace/ext/modelist').getModeForPath(e.model.fullPath()).mode),
