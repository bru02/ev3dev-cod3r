...
<script src="term.js"></script>
    ...
    <body>
        <div id="shell">
            ...
            <div id="shell-input" style="display:none;">
...
if (window.WebSocket) {
  ...
  socket.onopen = function () {
    ...
    socket.onmessage = function (data) {
      if (data.data == 'server:complete') {
        shellInput.style.display = 'block';
      } else term.write(data.data);
    };
...
if(loggedIn) {
  ...
  function genPrompt(cwd) {
    ...
    return `robot@ev3dev:<span title="${cwd}">${shortCwd}</span>#`;
  }
  ...
  function updateCwd(cwd) {
    ...
    makeRequest('?feature=pwd', {}, (response) => {
      CWD = response.cwd;
      _updatePrompt();
    });
  }
