    ...
    function (e) {
        ...
        e.module("FileManagerApp").controller("FileManagerCtrl", ["$scope", "$rootScope", "$window", "$translate", "fileManagerConfig", "item", "fileNavigator", "apiMiddleware", function (r, n, i, a, t, o, s, l) {
            ...
            r.config = t,
                ...
                r.uploadFileList = [],
                r.viewTemplate = d.getItem("viewTemplate") || "main-table.html",
                r.fileList = [],
                r.temps = [],
                ...
                ,
                r.prepareNewFolder = r.prepareNewFile = function () {
                ...
                ,
                r.createFile = function () {
                    var e = r.singleSelection()
                        , n = e.tempModel.name;
                    if (!n || r.fileNavigator.fileNameExists(n))
                        return r.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename");
                    r.apiMiddleware.createFile(e).then(function () {
                        r.fileNavigator.refresh(),
                            r.modal("newfile", !0)
                    })
                }
    ...
    function (e) {
        ...
        e.module("FileManagerApp").provider("fileManagerConfig", function () {
            var r = {
                ...
                extractAsync: !1,
                pickCallback: null,
                isEditableFilePattern: /\.(py|js|html|css|sh|txt)$/i,
    ...
    function (e) {
        ...
        angular.module("FileManagerApp").service("apiHandler", ["$http", "$q", "$window", "$translate", "$httpParamSerializer", "Upload", function (e, r, n, i, a, t) {
            ...
            class o {
                ...
                list(n, i, a, t) {
                    var o = this, s = a || o.deferredHandler, l = r.defer(), d = {
                        action: "list",
                        path: i,
                ...
                downloadMultiple(t, o, s, l, d) {
                    var c = this, p = r.defer(), m = [t, a({
                ...
                createFile(n, a) {
                    ...
                    return t.inprocess = !0,
                        ...
                        e.post(n, s).then(function (e) {
                            ...
                            t.deferredHandler(e.data, o, e.status, i.instant("error_creating_file"));
                        }).finally(function () {
                            t.inprocess = !1;
                        }),
                        o.promise;
    ...
    function (e) {
        ...
        angular.module("FileManagerApp").service("apiMiddleware", ["$window", "fileManagerConfig", "apiHandler", function (e, r, n) {
            class i {
                ...
                list(e, n) {
                    return this.apiHandler.list("bridge.py", this.getPath(e), n);
                }
                copy(e, n) {
                    var i = this.getFileList(e), a = 1 === i.length ? e[0].tempModel.name : void 0;
                    return this.apiHandler.copy("bridge.py", i, this.getPath(n), a);
                }
                move(e, n) {
                    var i = this.getFileList(e);
                    return this.apiHandler.move("bridge.py", i, this.getPath(n));
                }
                remove(e) {
                    var n = this.getFileList(e);
                    return this.apiHandler.remove("bridge.py", n);
                }
                upload(n, i) {
                    if (!e.FormData)
                        throw new Error("Unsupported browser version");
                    var a = this.getPath(i);
                    return this.apiHandler.upload("bridge.py", a, n);
                }
                getContent(e) {
                    var n = this.getFilePath(e);
                    return this.apiHandler.getContent("bridge.py", n);
                }
                edit(e) {
                    var n = this.getFilePath(e);
                    return this.apiHandler.edit("bridge.py", n, e.tempModel.content);
                }
                rename(e) {
                    var n = this.getFilePath(e), i = e.tempModel.fullPath();
                    return this.apiHandler.rename("bridge.py", n, i);
                }
                getUrl(e) {
                    var n = this.getFilePath(e);
                    return this.apiHandler.getUrl("bridge.py", n);
                }
                download(e, n) {
                    var i = this.getFilePath(e), a = e.model.name;
                    if (!e.isFolder())
                        return this.apiHandler.download("bridge.py", i, a, r.downloadFilesByAjax, n);
                }
                downloadMultiple(e, n) {
                    var i = this.getFileList(e), a = (new Date).getTime().toString().substr(8, 13) + "-" + r.multipleDownloadFileName;
                    return this.apiHandler.downloadMultiple("bridge.py", i, a, r.downloadFilesByAjax, n);
                }
                compress(e, n, i) {
                    var a = this.getFileList(e);
                    return this.apiHandler.compress("bridge.py", a, n, this.getPath(i));
                }
                extract(e, n, i) {
                    var a = this.getFilePath(e);
                    return this.apiHandler.extract("bridge.py", a, n, this.getPath(i));
                }
                changePermissions(e, n) {
                    var i = this.getFileList(e), a = n.tempModel.perms.toCode(), t = n.tempModel.perms.toOctal(), o = !!n.tempModel.recursive;
                    return this.apiHandler.changePermissions("bridge.py", i, a, t, o);
                }
                createFolder(e) {
                    var n = e.tempModel.fullPath();
                    return this.apiHandler.createFolder("bridge.py", n);
                }
                createFile(e) {
                    var n = e.tempModel.fullPath();
                    return this.apiHandler.createFile("bridge.py", n);
                }
            }
            return i
        }
